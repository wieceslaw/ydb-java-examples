...
import tech.ydb.coordination.recipes.example.apps.InterProcessMutexApp;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (GrpcTransport transport = GrpcTransport.forConnectionString(args[0])
            ...
            InterProcessMutexApp interProcessMutexApp = new InterProcessMutexApp(client);
            interProcessMutexApp.run();
